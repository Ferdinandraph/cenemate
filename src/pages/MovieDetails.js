...
import ImageAlt from '../assets/12317.jpg'
import { useTitle } from "../hooks/useTitle"

export const MovieDetails = () => {
  const params = useParams()
  const [movie, setMovie] = useState([])
  const images = movie.poster_path ? `https://image.tmdb.org/t/p/w500/${movie.poster_path}` : ImageAlt;

  const url = `https://api.themoviedb.org/3/movie/${params.id}?api_key=6d1b4275ee8584a406431e2ab53d5557`
